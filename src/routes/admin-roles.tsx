...
function RolesPage() {
  ...
  const roles = en ? [
    ...
    { id: "moderator", label: "Moderator", desc: "Review & verify applications" },
    { id: "support", label: "Support Agent", desc: "Manage chat & tickets" },
  ] : [
    { id: "admin", label: "Super Admin", desc: "Buong access sa sistema" },
    { id: "moderator", label: "Tagapamagitan", desc: "Suriin at kumpirmahin ang mga aplikasyon" },
    { id: "support", label: "Ahente ng Suporta", desc: "Pamahalaan ang usapan at mga hiling" },
  ];

  const permissions = en ? [
    ...
    { id: "dash", label: "Access sa Dashboard" },
    { id: "verify", label: "Kumpirmahin ang mga Aplikasyon" },
    { id: "reject", label: "Tanggihan ang mga Aplikasyon" },
    { id: "support", label: "Usapan sa Suporta" },
  ];
  ...
  return (
    <MobileShell>
      <TopBar title={en ? "Roles & Permissions" : "Mga Tungkulin at Pahintulot"} onBack={() => history.back()} />

      <div className="px-6 pt-4 pb-24 space-y-8">
        <section>
          <h2 className="text-[11px] font-black text-[#1b2b4b] uppercase tracking-wider ml-1 mb-4">{en ? "Select Role" : "Pumili ng Tungkulin"}</h2>
        ...
        <section>
          <h2 className="text-[11px] font-black text-[#1b2b4b] uppercase tracking-wider ml-1 mb-4">{en ? "Permissions" : "Mga Pahintulot"}</h2>
        ...
        >
          <ShieldCheck size={18} /> {en ? "Save Changes" : "Itala ang mga Pagbabago"}
        </button>
      </div>
    </MobileShell>
  );
